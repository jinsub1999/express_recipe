...
div.mywrapper
    ...
    div(class="bg-gray-300 p-3 m-2 w-3/4 max-w-md rounded-lg")
        div(class="p-1 m-2 bg-yellow-300 rounded-md") {{prod.name}}
        div(class="p-1 m-2 bg-yellow-300 rounded-md") {{prod.price}}
        div(class="p-1 m-2 bg-yellow-300 rounded-md") {{prod.amount}}
        div(class="p-1 m-2 bg-yellow-300 rounded-md") {{prod.seller}}
    div(class="bg-gray-300 p-3 m-2 w-3/4 max-w-md rounded-lg")
